...
function clinician_taxonomy() {
    ...
    register_taxonomy(
        'clinician-language',  // The name of the taxonomy. Name should be in slug form (must not contain capital letters or spaces).
        'clinician',             // post type name
        array(
            'hierarchical' => true,
            ...
            'query_var' => true,
            'rewrite' => array(
                'slug' => 'clinician-language',    // This controls the base slug that will display before each term
                'with_front' => false  // Don't display the category base before
            )
        )
    );
