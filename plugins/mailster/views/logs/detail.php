...
<table class="wp-list-table widefat fixed striped table-view-list logs">
	...
	<tr><th><?php esc_html_e( 'Sent', 'mailster' ); ?></th><td><?php echo esc_html( date_i18n( 'Y-m-d H:i:s', $log->timestamp + $timeoffset ) ); ?>, <?php printf( esc_html__( '%s ago', 'mailster' ), human_time_diff( $log->timestamp ) ); ?></td></tr>
